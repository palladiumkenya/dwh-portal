...
var a=r("QmqGcKws81")
if(!("require"in window)){var n=r("mOY9BNujNR"),i=function(e){return e.default},o={jquery:function(){return n},i18nObj:function(){return new Promise(function(e){e()}).then(r.bind(null,"36QOWIB4+W")).then(i)},underscore:function(){return new Promise(function(e){e()}).then(r.bind(null,"iBw8ZGM6v8")).then(i)},"jsx/course_wizard/ListItems":function(){return r.e(23).then(r.bind(null,"bzx8AghjTc")).then(i)}},d=function(e){if(e in o)return o[e]()
...
Promise.all(e.map(d)).then(function(e){t&&t.apply(void 0,Object(a.a)(e))})}}},GfsekNpohF:function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
...
Object.defineProperty(t,"__esModule",{value:!0})
var a=r("dDMppMtUiC"),n=r("VfnPWtOxDI"),i=r.n(n),o=r("Qwg4WMdjCp"),d=r.n(o),u=r("PJh52PO9+b"),l=r.n(u),c=r("1IKDY5pCFs")
r("AueD11u85v")
l()().locale(ENV.MOMENT_LOCALE)
if("undefined"!=typeof ENV){ENV.TIMEZONE&&c.a.changeZone(ENV.TIMEZONE)
ENV.CONTEXT_TIMEZONE&&c.a.preload(ENV.CONTEXT_TIMEZONE)
ENV.BIGEASY_LOCALE&&c.a.changeLocale(ENV.BIGEASY_LOCALE,ENV.MOMENT_LOCALE)}if(ENV.use_high_contrast)d.a.use()
else{var s=window.CANVAS_ACTIVE_BRAND_VARIABLES||{},f={}
"test"===window.INST.environment&&(f={transitions:{duration:"0ms"}})
i.a.use({overrides:Object(a.a)({},f,s)})}if("test"===window.INST.environment){window.__CANVAS_IN_FLIGHT_XHR_REQUESTS__=0
...
//# sourceMappingURL=appBootstrap.bundle-45371f0b50.js.113-45371f0b50.sourcemap