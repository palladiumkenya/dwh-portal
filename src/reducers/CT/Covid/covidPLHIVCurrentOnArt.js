...
export default (state = initialState, action) => {
    let newState = { ...state };
    switch (action.type) {
        case actionTypes.CT_COVID_PLHIV_CURRENT_ON_ART_REQUEST:
            newState.loading = true;
            return newState;
        case actionTypes.CT_COVID_PLHIV_CURRENT_ON_ART_FETCH:
            ...
            return newState;
        case actionTypes.CT_COVID_PLHIV_CURRENT_ON_ART_FAILED:
            newState.loading = false;
            return newState;
        default:
            return state
