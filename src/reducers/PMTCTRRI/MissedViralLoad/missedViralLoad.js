...
export default (state = initialState, action) => {
    let newState = { ...state };
    switch (action.type) {
        case actionTypes.PMTCT_RRI_MISSED_VIRAL_LOAD_REQUEST:
            newState.loading = true;
            return newState;
        case actionTypes.PMTCT_RRI_MISSED_VIRAL_LOAD_FETCH:
            ...
            return newState;
        case actionTypes.PMTCT_RRI_MISSED_VIRAL_LOAD_FAILED:
            newState.loading = false;
