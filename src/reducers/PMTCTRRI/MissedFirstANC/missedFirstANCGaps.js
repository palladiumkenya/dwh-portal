...
export default (state = initialState, action) => {
    let newState = { ...state };
    switch (action.type) {
        case actionTypes.PMTCT_RRI_MISSED_FIRST_ANC_GAPS_REQUEST:
            newState.loading = true;
            return newState;
        case actionTypes.PMTCT_RRI_MISSED_FIRST_ANC_GAPS_FETCH:
            ...
            return newState;
        case actionTypes.PMTCT_RRI_MISSED_FIRST_ANC_GAPS_FAILED:
            newState.loading = false;
