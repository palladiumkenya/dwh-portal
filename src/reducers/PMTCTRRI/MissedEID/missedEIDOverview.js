...
export default (state = initialState, action) => {
    let newState = { ...state };
    switch (action.type) {
        case actionTypes.PMTCT_RRI_MISSED_EID_OVERVIEW_REQUEST:
            newState.loading = true;
            return newState;
        case actionTypes.PMTCT_RRI_MISSED_EID_OVERVIEW_FETCH:
            ...
            return newState;
        case actionTypes.PMTCT_RRI_MISSED_EID_OVERVIEW_FAILED:
            newState.loading = false;
