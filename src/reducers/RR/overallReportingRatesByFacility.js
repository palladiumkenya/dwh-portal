...
export default (state = initialState, action) => {
    let newState = { ...state };
    switch (action.type) {
        case actionTypes.RR_OVERALL_REPORTING_RATES_BY_FACILITY_REQUEST:
            newState.loading[action.payload.docket] = true;
            return newState;
        case actionTypes.RR_OVERALL_REPORTING_RATES_BY_FACILITY_FETCH:
            ...
            return newState;
        case actionTypes.RR_OVERALL_REPORTING_RATES_BY_FACILITY_REQUEST_FAILED:
            newState.loading[action.payload.docket] = false;
            return newState;
        default:
            return state
