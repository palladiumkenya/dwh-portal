...
export const getAdverseEventsSeverityActions = createSelector(
    ...
    (listUnfiltered, listFiltered, filtered) => {
        ...
        const undocumented = list.filter(obj => obj.AdverseEventActionTaken === 'Undocumented');
        ...
        const medicineNotChanged = list.filter(obj => obj.AdverseEventActionTaken === 'Medicine not changed');
        ...
        const doseReduced = list.filter(obj => obj.AdverseEventActionTaken === 'Dose reduced');
        ...
        const medicineWithdrawn = list.filter(obj => obj.AdverseEventActionTaken === 'Medicine causing AE substituted/withdrawn');
        ...
        const allDrugsStopped = list.filter(obj => obj.AdverseEventActionTaken === 'All drugs stopped');
