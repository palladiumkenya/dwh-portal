...
const HisDeploymentsFacilityLevelByOwnershipPartner = () => {
    const [hisDeployments, setHisDeployments] = useState({});
    const hisStatusData = useSelector(
        hisSelector.getFacilityLevelByPartner
    );

    const loadHisLevelByPartner = useCallback(async () => {
        setHisDeployments({
            chart: {
                type: 'column',
            },
            ...
            <div className="col-12">
                <Card className="trends-card">
                    <CardHeader className="trends-header">
                        ACTIVE FACILITY LEVEL BY OWNERSHIP (PARTNER)
                    </CardHeader>
