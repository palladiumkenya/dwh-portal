...
const RROverviewTrendsN = () => {
    ...
    const loadOverallReportingTrend = useCallback(async () => {
        ...
        setOverallReportingTrend({
            ...
            yAxis: [
                { title: { text: 'Percentage' }, labels: { format: '{value}' } },
            ],
            ...
            series: [ { name: "Overall Reporting Rates", type: "column", data: dataProcessed, color: "#1AB394" } ]
        });
    ...
    const loadConsistencyTrend = useCallback(async () => {
        ...
        setConsistencyTrend({
            ...
            tooltip: { valueSuffix: ' %' },
            legend: { enabled: false },
            series: [ { name: "Consistency of Reporting", type: "column", data: dataProcessed, color: "#2F4050" } ]
        });
    }, [filters, rrTab, expected]);
...
export default RROverviewTrendsN;
