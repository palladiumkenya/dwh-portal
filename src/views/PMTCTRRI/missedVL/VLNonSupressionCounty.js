...
const VLNonSupressionCounty = () => {
    let missedVL = useSelector(
        missedVLSelectors.getMissedViralLoadCountyNonSup
    );
    const [
    ...
    return (
        <Card>
            <CardHeader className="cardTitle">
                {`NUMBER OF VIRAL LOAD NON SUPPRESION BY COUNTY`}
            </CardHeader>
            <CardBody>
                <HighchartsReact
...
export default VLNonSupressionCounty;
