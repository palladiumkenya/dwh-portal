...
const NewlyDiagnosedNoInfantProfCounty = () => {
    const missedInfantProf = useSelector(
        missedInfantProphylaxisSelectors.getMissedInfantProphylaxisCountyAmongNewPos
    );
    const [
    ...
    const loadPrepEligibleVsNewInitiatedTrends = useCallback(async () => {
        setPrepEligibleVsNewInitiatedTrends({
            ...
            xAxis: {
                categories: missedInfantProf.counties,
                crosshair: true,
                title: {
                    text: 'COUNTY',
                },
    ...
    return (
        <Card>
            <CardHeader className="cardTitle">
                {`NUMBER NOT GIVEN INFANT PROPHYLAXIS AT FIRST ANC AMONG NEWLY DIAGNOSED MOTHERS BY COUNTY`}
            </CardHeader>
            <CardBody>
                <HighchartsReact
...
export default NewlyDiagnosedNoInfantProfCounty;
