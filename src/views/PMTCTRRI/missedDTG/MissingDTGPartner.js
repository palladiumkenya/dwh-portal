...
const MissingDTGPartner = () => {
    const missedDTG = useSelector(
        missedEIDTestingSelectors.getMissedDTGSDP
    );
    const [
    ...
    return (
        <Card>
            <CardHeader className="cardTitle">
                {`CALHIV MISSED DTG OPTIMIZATION BY PARTNER`}
            </CardHeader>
            <CardBody>
                <HighchartsReact
...
export default MissingDTGPartner;
