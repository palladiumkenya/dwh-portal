...
const PNSChildrenFamilyTestingPositivityTrends = ({ globalFilters }) => {
    ...
    const loadPNSChildrenFamilyTestingPositivityTrends = useCallback(async () => {
        ...
        setPNSChildrenFamilyTestingPositivityTrends({
            ...
            series: [
                { name: 'Number Tested', type: 'column', data: tested_new, yAxis: 0, color: "#485969",  dataLabels: { enabled: true }, tooltip: { valueSuffix: ' ' } },
                { name: 'Number Linked ', type: 'column', data: tested_retest, yAxis: 0, color: "#1AB394",  dataLabels: { enabled: true }, tooltip: { valueSuffix: ' ' } },
