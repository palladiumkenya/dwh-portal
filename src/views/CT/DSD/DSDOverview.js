            ...
            <div className="row">
                    ...
                    <Card className="card-uploads-consistency-rates">
                        ...
                        >
                            <div className="col-12">
                                <span className="expected-uploads-text">{dsdStabilityStatus.txCurr}</span>
                            </div>
                        </CardBody>
                    </Card>
                </div>
                <div className="col-4">
                    <Card className="card-uploads-consistency-rates">
                        ...
                        >
                            <div className="col-12">
                                <span className="expected-uploads-text">{dsdStabilityStatus.mmd}</span>
                ...
                <div className="col-4">
                    <Card className="card-uploads-consistency-rates">
                        ...
                        >
                            <div className="col-12">
                                <span className="expected-uploads-text">{dsdStabilityStatus.stable}</span>
            ...
            <div className="row">
                <div className="col-4">
                    <Card className="card-uploads-consistency-rates">
                        ...
                        >
                            <div className="col-12">
                                <span className="expected-uploads-text">{dsdUnstable.onArtLessThan12Months}</span>
                ...
                <div className="col-4">
                    <Card className="card-uploads-consistency-rates">
                        ...
                        >
                            <div className="col-12">
                                <span className="expected-uploads-text">{dsdUnstable.highVl}</span>
                    ...
                    <Card className="card-uploads-consistency-rates">
                        ...
                        >
                            <div className="col-12" style={{ textAlign: 'center' }}>
                                <span className="overall-rates-figure">{dsdUnstable.poorAdherence}</span>
