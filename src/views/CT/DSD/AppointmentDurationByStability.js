...
const AppointmentDurationByStability = () => {
    ...
    const loadAppointmentDurationByStability = useCallback(async () => {
        setAppointmentDurationByStability({
            ...
            series: [
                { name: 'MMD', data: appointmentDurationByStabilityStatus.data[1], type: 'column', color: "#1AB394", tooltip: { valueSuffix: ' ({point.percentage:.0f}%)' } },
                { name: 'NON MMD', data: appointmentDurationByStabilityStatus.data[0], type: 'column', color: "#485969", tooltip: { valueSuffix: ' ({point.percentage:.0f}%)' } },
            ]
        });
