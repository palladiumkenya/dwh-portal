...
const AdverseEventsProportionOfPlHivWithAeRelatedToArtOrSuspectedArt = ({ tab }) => {
    ...
    const loadProportionOfPlHivWithAeRelatedToArt = useCallback(async () => {
        setProportionOfPlHivWithAeRelatedToArt({
            ...
            xAxis: {
                categories: adverseEventsProportionOfPLHIVAeRelatedToArtDrugs.map(obj => obj.adverseEventCause.toUpperCase()),
                crosshair: true
            },
            yAxis: {
                min: 0,
