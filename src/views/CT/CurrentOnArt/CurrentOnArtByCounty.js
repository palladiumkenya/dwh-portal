...
const CurrentOnArtByCounty = () => {
    ...
    const loadCurrentOnArtByCountyChart = useCallback(async () => {
        setCurrentOnArtByCountyChart({
            title: { text: '' },
            xAxis: [{ categories: currentOnArtByCountyData.counties, crosshair: true }],
            yAxis: [{ title: { text: '' }}],
            ...
            series: [{ data: currentOnArtByCountyData.currentOnArt, name: 'Number currently on ART', type: 'column', color: "#142459" }]
        });
...
export default CurrentOnArtByCounty;
