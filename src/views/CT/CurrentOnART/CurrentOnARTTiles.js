...
const CurrentOnARTTiles = () => {
    ...
    const loadHomeVLCascade = useCallback(async () => {
        ...
        setCurrentOnArtTiles({
            ...
            highViremiaPercent: typeof data[4] !== 'undefined' && typeof data[0] !== 'undefined' && data[4] !== 0 && data[0] !== 0 ? parseFloat(((data[4]/data[0])*100).toString()).toFixed(0) + '%' : 0 + '%',
            lowViremia: data[5],
            lowViremiaText: data[5].toLocaleString('en'),
            lowViremiaPercent: typeof data[5] !== 'undefined' && typeof data[0] !== 'undefined' && data[5] !== 0 && data[0] !== 0 ? parseFloat(((data[5]/data[0])*100).toString()).toFixed(0) + '%' : 0 + '%',
        });
    }, [filters]);
