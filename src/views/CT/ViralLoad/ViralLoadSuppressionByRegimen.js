    ...
    const loadViralLoadSuppressionByRegimen = useCallback(async () => {
        setViralLoadSuppressionByRegimen({
            ...
            xAxis: [
                {
                    categories:
                        viralLoadSuppressionByRegimenData.regimenCategories,
                    crosshair: true,
                },
            ],
            ...
            series: [
                {
                    name: 'HIGH RISK LLV',
                    data: viralLoadSuppressionByRegimenData.data[1],
                    type: 'column',
                    color: '#E15759',
                ...
                {
                    name: 'LOW RISK LLV',
                    data: viralLoadSuppressionByRegimenData.data[2],
                    type: 'column',
                    color: '#F28E2B',
                    tooltip: { valueSuffix: ' ({point.percentage:.0f}%)' },
                },
                {
                    name: 'LDL',
                    data: viralLoadSuppressionByRegimenData.data[0],
                    type: 'column',
                    color: '#3475B3',
                    tooltip: { valueSuffix: ' ({point.percentage:.0f}%)' },
                },
