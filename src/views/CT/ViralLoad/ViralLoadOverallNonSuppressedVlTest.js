...
import {
    getViralLoadOverallUptakeGt1000CopiesReceivedFollowTestAllData
} from '../../../selectors/CT/ViralLoad/viralLoadOverallUptakeGt1000Copies';
...
const ViralLoadOverallNonSuppressedVlTest = () => {
            ...
            series: [
                {
                    ...
                    data: [
                        ...
                        },
                        {
                            ...
                            color: '#1c943e',
                            text: "EAC 3 " + viralLoadUptakeGt1000CopiesEac.EACVisitDate_3.toLocaleString('en') + ' (' + parseFloat(((viralLoadUptakeGt1000CopiesEac.EACVisitDate_3 /  Object.values(viralLoadUptakeGt1000CopiesEac).reduce((a, b) => a + b, 0)) * 100).toString()).toFixed(0) + '%)',
                        ...
                        //     y: 1000,
                        //     color: '#142459',
                        //     text: 100, //+ ' (' + parseFloat(((viralLoadSupCascade[0] / viralLoadSupCascade.reduce((a, b) => a + b, 0)) * 100).toString()).toFixed(0) + '%)',
                        //     // cText: 'Male: ' + viralLoadOverallUptakeSuppressionBySexData.data[0][3] + ' <br /> Female: ' + viralLoadOverallUptakeSuppressionBySexData.data[1][3]
                        // }
                    ]
                },
                {
                    ...
                    data: [
                        null,
                        {
                            ...
                            color: '#e88134',
                            text: "EAC 2 " + viralLoadUptakeGt1000CopiesEac.EACVisitDate_2.toLocaleString('en') + ' (' + parseFloat(((viralLoadUptakeGt1000CopiesEac.EACVisitDate_2 /  Object.values(viralLoadUptakeGt1000CopiesEac).reduce((a, b) => a + b, 0)) * 100).toString()).toFixed(0) + '%)',
                            // cText: 'Male: ' + viralLoadOverallUptakeSuppressionBySexData.data[0][1] + ' <br /> Female: ' + viralLoadOverallUptakeSuppressionBySexData.data[1][1]
                        },
                        null,
                        {
                ...
                },
                {
                    ...
                    data: [
                        null,
                        {
                            ...
                            color: '#bb1414',
                            text: "EAC 1 " + viralLoadUptakeGt1000CopiesEac.EACVisitDate_1.toLocaleString('en') + ' (' + parseFloat(((viralLoadUptakeGt1000CopiesEac.EACVisitDate_1 /  Object.values(viralLoadUptakeGt1000CopiesEac).reduce((a, b) => a + b, 0)) * 100).toString()).toFixed(0) + '%)',
                            // cText: 'Male: ' + viralLoadOverallUptakeSuppressionBySexData.data[0][1] + ' <br /> Female: ' + viralLoadOverallUptakeSuppressionBySexData.data[1][1]
                        },
                        null,
                        null,
    ...
    }, [viralLoadUptakeGt1000Copies, viralLoadUptakeGt1000CopiesEac, viralLoadUptakeGt1000CopiesRecFollowTestAll, viralLoadOverallUptakeSuppressionBySexVlDoneData, viralLoadOverallUptakeSuppressionReferredLessIntenseData]);
