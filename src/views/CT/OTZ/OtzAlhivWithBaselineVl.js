...
const OtzAlhivWithBaselineVl = () => {
    const [
        otzOutcomesAmongAlHivWithBaselineVL,
        setOtzOutcomesAmongAlHivWithBaselineVL,
    ] = useState({});
    const otzOutcomesWithBaselineVl = useSelector(
        otzOutcomesAmongAlhivWithBaselineVL.getOtzOutcomesAmongAlHivWithBaselineVL
    );
            ...
            <CardBody className="trends-body">
                <div className="col-12">
                    <HighchartsReact
                        ...
                        options={otzOutcomesAmongAlHivWithBaselineVL}
                    />
                </div>
            </CardBody>
        </Card>
...
export default OtzAlhivWithBaselineVl;
