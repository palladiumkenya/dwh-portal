...
const DistributionDensityCOC = ({ globalFilter }) => {
    ...
    const loadChart = async () => {
        ...
        const data = await getAll('/getHCWDensity/2/all/all/all');
        setChart({
            chart: {
                zoomType: 'xy'
            },
            title: {
                text: 'Distribution and Density of Clinical Officers by County'
            },
            subtitle: {
    ...
    return (
        <div className="row">
            <div className="col-12">
                <legend>Distribution and Density of Clinical Officers by County</legend>
