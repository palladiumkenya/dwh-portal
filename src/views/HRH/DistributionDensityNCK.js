...
const DistributionDensityNCK = ({ globalFilter }) => {
    ...
    const loadChart = async () => {
        ...
        const data = await getAll('/getHCWDensity/1/all/all/all');
        setChart({
            chart: {
                zoomType: 'xy'
            },
            title: {
                text: 'Distribution and Density of Nurses and Midwives by County'
            },
            subtitle: {
    ...
    return (
        <div className="row">
            <div className="col-12">
                <legend>Distribution and Density of Nurses and Midwives by County</legend>
