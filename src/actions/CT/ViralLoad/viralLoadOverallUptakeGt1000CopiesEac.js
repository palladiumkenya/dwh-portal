...
export const loadViralLoadOverallUptakeGt1000CopiesEac = (tab) => async (dispatch, getState) => {
    const diffInMinutes = moment().diff(
        moment(getState().viralLoadOverallUptakeGt1000CopiesEac.lastFetch),
        'minutes'
    );
...
export const fetchViralLoadOverallUptakeGt1000Copies = () => async (dispatch, getState) => {
    dispatch({ type: actionTypes.CT_VIRAL_LOAD_OVERALL_UPTAKE_GT_1000_COPIES_EAC_REQUEST });
    const params = {
