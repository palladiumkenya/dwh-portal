...
export const loadArtOptimizationCurrentByRegimen =
...
export const fetchArtOptimizationCurrentByRegimen =
    () => async (dispatch, getState) => {
        dispatch({
            type: actionTypes.CT_ART_OPTIMIZATION_CURRENT_BY_REGIMEN_REQUEST,
        });
        const params = {
        ...
        const response = await getAll(
            'care-treatment/getArtOptimizationCurrentByRegimen',
            params
        );
        dispatch({
            type: actionTypes.CT_ART_OPTIMIZATION_CURRENT_BY_REGIMEN_FETCH,
